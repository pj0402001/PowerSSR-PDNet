...
\begin{table}[!t]
  ...
  \begin{tabular}{lcc}
    ...
    \midrule
    Classification Acc & 0.9945 & 0.9915 \\
    Classification F1 & 0.9891 & 0.9831 \\
    Precision / Recall & 0.9785 / 1.0000 & 0.9737 / 0.9927 \\
    State MAE (overall) & 0.0914 & 0.0949 \\
    MAE: $P_{G1}$ (MW) & 0.8552 & 0.8366 \\
    MAE: $Q_{G1:3}$ (MVAR) & 0.1323 & 0.1588 \\
    MAE: $V_{1:9}$ (p.u.) & 0.0009 & 0.0010 \\
    MAE: $\theta_{1:9}$ (deg) & 0.0833 & 0.0850 \\
    \bottomrule
  \end{tabular}
\end{table}
...
\texttt{results/case9mod\_fullstate\_point\_comparison.csv}, where each row
